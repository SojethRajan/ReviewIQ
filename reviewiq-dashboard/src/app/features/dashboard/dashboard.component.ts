...
import { countBySeverity, getCriticalCount, getScoreClass, getSuggestionCount, getWarningCount } from '../../core/utils/review-utils';
...
export class DashboardComponent {
    ...
    protected countBySeverity = countBySeverity;
